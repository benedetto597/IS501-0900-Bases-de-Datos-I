...
-- Se limpia de las comillas al comando
...
SELECT
    ...
    CASE 
        WHEN STRCMP(@lastCommand,"INBOX") THEN "Solicitud de Inbox SMTP de la bandeja del correo"
        WHEN STRCMP(@lastCommand,"TRASH") THEN "Solicitud de Trash SMTP de la bandeja del correo"
        ELSE "Instrucción desconocida"
...
SELECT
    ...
    END AS "Acción solicitada (LIKE)",
    CASE 
        WHEN STRCMP(TRIM(@lastCommand),"INBOX") THEN "Solicitud de Inbox SMTP de la bandeja del correo"
        WHEN STRCMP(TRIM(@lastCommand),"TRASH") THEN "Solicitud de Trash SMTP de la bandeja del correo"
        ELSE "Instrucción desconocida"
    END AS "Acción solicitada (STRCMP)"
;
